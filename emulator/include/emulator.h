...
static const struct instruction ISA[] = {
	...
	[I_MOVR_INSTRUCTION] = DEFINE_INSTRUCTION("ADD", ONE_ARGUMENT),
	...
	[I_MOVR_INSTRUCTION] = DEFINE_INSTRUCTION("SUB", ONE_ARGUMENT),
	...
	[I_MOVR_INSTRUCTION] = DEFINE_INSTRUCTION("MUL", ONE_ARGUMENT),
	...
	[I_MOVR_INSTRUCTION] = DEFINE_INSTRUCTION("DIV", ONE_ARGUMENT),
	...
	[I_MOVR_INSTRUCTION] = DEFINE_INSTRUCTION("SHR", ONE_ARGUMENT),
	...
	[I_MOVR_INSTRUCTION] = DEFINE_INSTRUCTION("SHL", ONE_ARGUMENT),
	...
	[I_MOVR_INSTRUCTION] = DEFINE_INSTRUCTION("OR", ONE_ARGUMENT),
	...
	[I_MOVR_INSTRUCTION] = DEFINE_INSTRUCTION("AND", ONE_ARGUMENT),
	...
	[I_MOVR_INSTRUCTION] = DEFINE_INSTRUCTION("NOT", ONE_ARGUMENT),
	...
	[I_JMPI_INSTRUCTION] = DEFINE_INSTRUCTION("JMP", ONE_ARGUMENT),

	[I_CALL_INSTRUCTION] = DEFINE_INSTRUCTION("CALL", ONE_ARGUMENT),
	[I_CALLI_INSTRUCTION] = DEFINE_INSTRUCTION("CALL", ONE_ARGUMENT),

	[I_JE_INSTRUCTION] = DEFINE_INSTRUCTION("JE", ONE_ARGUMENT),
	[I_JEI_INSTRUCTION] = DEFINE_INSTRUCTION("JE", ONE_ARGUMENT),
	
	[I_JNE_INSTRUCTION] = DEFINE_INSTRUCTION("JNE", ONE_ARGUMENT),
	[I_JNEI_INSTRUCTION] = DEFINE_INSTRUCTION("JE", ONE_ARGUMENT),
	
	[I_JG_INSTRUCTION] = DEFINE_INSTRUCTION("JG", ONE_ARGUMENT),
	[I_JGI_INSTRUCTION] = DEFINE_INSTRUCTION("JE", ONE_ARGUMENT),
	
	[I_JGE_INSTRUCTION] = DEFINE_INSTRUCTION("JGE", ONE_ARGUMENT),
	[I_JGEI_INSTRUCTION] = DEFINE_INSTRUCTION("JE", ONE_ARGUMENT),
	
	[I_JL_INSTRUCTION] = DEFINE_INSTRUCTION("JL", ONE_ARGUMENT),
	[I_JLI_INSTRUCTION] = DEFINE_INSTRUCTION("JE", ONE_ARGUMENT),
	
	[I_JLE_INSTRUCTION] = DEFINE_INSTRUCTION("JLE", ONE_ARGUMENT),
	[I_JLEI_INSTRUCTION] = DEFINE_INSTRUCTION("JE", ONE_ARGUMENT),
	
	[I_JC_INSTRUCTION] = DEFINE_INSTRUCTION("JC", ONE_ARGUMENT),
	[I_JCI_INSTRUCTION] = DEFINE_INSTRUCTION("JE", ONE_ARGUMENT),
	
	[I_JNC_INSTRUCTION] = DEFINE_INSTRUCTION("JNC", ONE_ARGUMENT),
	[I_JNCI_INSTRUCTION] = DEFINE_INSTRUCTION("JE", ONE_ARGUMENT),
	
	[I_JZ_INSTRUCTION] = DEFINE_INSTRUCTION("JZ", ONE_ARGUMENT),
	[I_JZI_INSTRUCTION] = DEFINE_INSTRUCTION("JE", ONE_ARGUMENT),
	
	[I_JNZ_INSTRUCTION] = DEFINE_INSTRUCTION("JNZ", ONE_ARGUMENT),
	[I_JNZI_INSTRUCTION] = DEFINE_INSTRUCTION("JE", ONE_ARGUMENT),
	
	[I_PUSH_INSTRUCTION] = DEFINE_INSTRUCTION("PUSH", ONE_ARGUMENT),
	[I_PUSHR_INSTRUCTION] = DEFINE_INSTRUCTION("PUSH", ONE_ARGUMENT),
	[I_PUSHI_INSTRUCTION] = DEFINE_INSTRUCTION("PUSH", ONE_ARGUMENT),

	[I_POP_INSTRUCTION] = DEFINE_INSTRUCTION("POP", ONE_ARGUMENT),
	[I_POPR_INSTRUCTION] = DEFINE_INSTRUCTION("PUSH", ONE_ARGUMENT),
	[I_POPI_INSTRUCTION] = DEFINE_INSTRUCTION("PUSH", ONE_ARGUMENT),
