...
static const struct instruction ISA[] = {
	...
	[I_MOVA_INSTRUCTION] = DEFINE_INSTRUCTION("MOVA", ONE_ARGUMENT),
	[I_MOVB_INSTRUCTION] = DEFINE_INSTRUCTION("MOVB", ONE_ARGUMENT),
	[I_MOVC_INSTRUCTION] = DEFINE_INSTRUCTION("MOVC", ONE_ARGUMENT),
	[I_MOVD_INSTRUCTION] = DEFINE_INSTRUCTION("MOVD", ONE_ARGUMENT),
	[I_MOVSP_INSTRUCTION] = DEFINE_INSTRUCTION("MOVSP", ONE_ARGUMENT),
	[I_MOVBP_INSTRUCTION] = DEFINE_INSTRUCTION("MOVBP", ONE_ARGUMENT),
	[I_MOVIP_INSTRUCTION] = DEFINE_INSTRUCTION("MOVIP", ONE_ARGUMENT),
	[I_MOVI1_INSTRUCTION] = DEFINE_INSTRUCTION("MOVI1", ONE_ARGUMENT),
	[I_MOVI2_INSTRUCTION] = DEFINE_INSTRUCTION("MOVI2", ONE_ARGUMENT),
	[I_MOVI3_INSTRUCTION] = DEFINE_INSTRUCTION("MOVI3", ONE_ARGUMENT),
	[I_MOVI4_INSTRUCTION] = DEFINE_INSTRUCTION("MOVI4", ONE_ARGUMENT),
